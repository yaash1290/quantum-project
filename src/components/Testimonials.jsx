...
const Testimonial = () => {
  ...
  return (
    <>
    <div className="container-fluid contact-section py-5 text-center">
    <p className="display-4" id="testimonials">Testimonials</p>
    </div>
      ...
      >
        ...
        <div className="container mb-5" style={{ width: "95%" }}>
